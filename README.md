...
O arquivo de entrada contém um texto (primeiro nome do vendedor)
 2 valores (numérico), representando o salário fixo do vendedor e montante total das vendas efetuadas por este vendedor, respectivamente.
